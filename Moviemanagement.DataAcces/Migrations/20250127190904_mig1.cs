    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Tom Hanks was born in 1956 in California" },
                    { 2, 2, "Keanu Reeves was born in 1964 in Lebanon" },
                    { 3, 3, "Will Smith was born in 1968 in Pennsylvania" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Box Office we coming", "Forrest Gump" },
                    { 2, 2, "Box Office we coming", "The Matrix" },
                    { 3, 3, "Box Office we coming", "The Pursuit of Happyness" }
                });
